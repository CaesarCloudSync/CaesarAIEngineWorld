...
class CaesarCRUD:
    ...
    def update_blob(self,fieldstoupdate:str,value:bytes,table=str,condition=str):
        updatestr = "UPDATE %s SET %s = x'%s' WHERE %s;" % (table,fieldstoupdate,value.hex(),condition)
